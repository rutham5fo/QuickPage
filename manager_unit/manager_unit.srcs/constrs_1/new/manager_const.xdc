...
set_output_delay -clock "sys_clk" -max 0.5 [get_ports [list "o_busy" "o_rep_alloc_vld" "o_rep_dealloc_vld" "o_rep_data"]];
set_output_delay -clock "sys_clk" -min 0.5 [get_ports [list "o_busy" "o_rep_alloc_vld" "o_rep_dealloc_vld" "o_rep_data"]];
