...
HD_PWD='C:/VivadoProjects/vdmmu/manager_unit/manager_unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log quick_page.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source quick_page.tcl
